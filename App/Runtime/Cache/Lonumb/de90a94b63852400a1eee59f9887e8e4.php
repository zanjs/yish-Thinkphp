...
<!-------------------------
  网站分离页Main
  -------------------------->
<form action="/Lonumb/Work/edit" method="post">
<div class="mainBox">
  <div class="main">
     ...
     <div class="m_forms">
       <dl>
         ...
         <dd>
           <label>标签 : </label>
           <input id="flagName" class="input_on1 onbutton" type="text" value="<?php echo ($art['flagName']); ?>" readonly="readonly">
           <input id="flagId" class="input_on1" type="hidden" name="flag" value="<?php echo ($art['flag']); ?>">
         ...
         <dd>
           <label>简介 : </label>
           <textarea name="subcontent"><?php echo ($art['subcontent']); ?></textarea>
         </dd>                 
         <dd>
           <label>内容介绍 : </label>
           <textarea name="content1" id="MyContent"><?php echo ($art['content1']); ?></textarea>
         </dd>         
         <dd>
           <label>推荐首页 : </label>
           <input type="text" name="recommend" value="<?php echo ($art['recommend']); ?>">
         </dd>
         <dd>
           <label>排序 : </label>
...
<div class="flagBox">
  <div class="fbTag">
    <h1><strong>选择标签</strong><a href="/Lonumb/WorkTag">创建新标签!</a></h1>
    <ul>
    	<?php if(is_array($wtag)): $i = 0; $__LIST__ = $wtag;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$wtag): $mod = ($i % 2 );++$i;?><li><input type="checkbox" value="<?php echo ($wtag['id']); ?>"><label><?php echo ($wtag['title']); ?></label></li><?php endforeach; endif; else: echo "" ;endif; ?>
    </ul>
    <dl>
      <dt>确认选择</dt>
      <dd>取消并返回</dd>

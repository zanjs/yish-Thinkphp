...
<div class="mainBox">
  <div class="main">
    <form action="/Lonumb/Set/index"  method="Post" name="site_set">
     ...
     <div class="m_forms">
       ...
       <dl>
         <dd>
           <label>网站地址 : </label>
           <input type="text" name="sitehost" value="<?php echo ($set['sitehost']); ?>">
           <input type="hidden" name="id" value="<?php echo ($set['id']); ?>">
         </dd>
         <dd>
           <label>网站名称 : </label>
           <input type="text" name="sitename" value="<?php echo ($set['sitename']); ?>">
         </dd>
         <dd>
           <label>网站LOGO : </label>
           <input class="input_on1" type="text" name="logo" id="url1" value="<?php echo ($set['logo']); ?>">
           <input class="input_on2" type="button" value="浏览" id="image1">
         </dd>
         <dd>
           <label>统计代码 : </label>
           <textarea name="code"><?php echo ($set['code']); ?></textarea>
         </dd>
       </dl>
